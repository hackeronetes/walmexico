...
export const NaturalPersonStep2: React.FC<any> = (props) => {
            ...
            <form onSubmit={onSubmit} encType='multipart/form-data'>
                ...
                <div className='row'>
                    <div className='col s12'>
                        <Input disabled={true} field={FormFields.addressOfInterest} register={register} error={errors.addressOfInterest} />
                    </div>
