...
import {NaturalPersonStep1} from '../components/forms/NaturalPersonStep1'
import {NaturalPersonStep2} from '../components/forms/NaturalPersonStep2'
import {MainTitle} from '../components/common/Titles'
import {TextP} from '../components/common/TextP'
import { postNaturalPersonForm } from '../services/landSale/landSaleService'
...
export const NaturalPerson: React.FC = () => {
    ...
    const postFormData = (allFormValues: any) => {
        ...
        allFormValues.moralPerson = false;

         postNaturalPersonForm(allFormValues).then(() => {
            dispatch(setLoader(false));
                ...
                <div className='page-content'>
                    ...
                    <div className='multistep-container'>
                        <MultiStep numberSteps={2} activeStep={0} showNavigation={true} stepCustomStyle={{ width: '32%' }}>
                            <NaturalPersonStep1  saveFormValues={saveFormValues1} formValues={formValues1} />
                            <NaturalPersonStep2  saveFormValues={saveFormValues2} formValues={formValues2} submitForm={submitForm} />
                        </MultiStep>
                    </div>
