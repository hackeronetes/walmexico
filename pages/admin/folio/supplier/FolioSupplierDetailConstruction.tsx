...
import { getStatusOptions, getFolioUsersSupplier, postAssignUserLc, postchangeFolioStatusMaterial, getSupplierHistoryExportData } from '../../../../services/folioTracking/folioTrackingService'
import Select from 'react-select'
...
import { FOLIO_STATUS, SUBTYPE_CON, TYPE_SUPP } from '../constants'
...
export const FolioSupplierDetailConstruction: React.FC<Props> = (props) => {
    ...
    /*const startExcel = () => {
        ...
        getSupplierHistoryExportData(paramsTemp).then((response: any) => {
            if (response.data)
    ...
    const RenderExportExcelWithLinks = () => {
        ...
        const exportFunc = async () => {
            ...
            if (responseData.data.length == 1) {
                ...
                //arry.push([responseData.data[0].pictFOLIO,responseData.data[0].estatus,responseData.data[0].fecha,arry1[0],responseData.data[0].usuario_INTERNO,responseData.data[0].comentario ] );
                ...
                <div className='page-content'>
                    ...
                    <div className='forms-container'>
                        <CollapsibleFolio >
                            ...
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.typePerson} value={lcData.typeOfPerson} disabled={true} />
                                </div>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.contactName} value={lcData.userName} disabled={true} />
                                </div>
                            ...
                            <div className='row'>
                                ...
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specialtyRequestedBuilder} value={lcData.builderWorkDes} disabled={true} />
                                </div>
                            </div>
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specialtyRequestedSupervisor} value={lcData.constructionSupervisorDes} disabled={true} />
                                </div>

                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specialtyRequestedLaboratory} value={lcData.laboratoryDes} disabled={true} />
                                </div>
                            </div>
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specialtyRequestedDesigner} value={lcData.designerDes} disabled={true} />
                                </div>

                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specialtyRequestedElectrical} value={lcData.electicalConnectionDes} disabled={true} />
                                </div>
                            </div>
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specialtyRequestedSpecialist} value={lcData.dnSpecialistDes} disabled={true} />
                                </div>

                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.dateStart} value={lcData.startDateOfOperation} disabled={true} />
                                </div>
                            </div>
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.surfaceArea} value={lcData.areaOfOfficeFacilities} disabled={true} />
                                </div>

                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.staffNo} value={lcData.numberDs} disabled={true} />
                                </div>
                            </div>
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.experience} value={lcData.curricularExperience} disabled={true} />
                                </div>

                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.revnue} value={lcData.revenueBilled} disabled={true} />
                                </div>
                            </div>
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.annualReturn} value={lcData.annualDeclaration} disabled={true} />
                                </div>

                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.workingCapital} value={lcData.workingCapital} disabled={true} />
                                </div>
                            </div>
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.capital} value={lcData.financialStatement} disabled={true} />
                                </div>
                            ...
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.walmartRegistry} value={renderYesNo(lcData.prevPardon)} disabled={true} />
                                </div>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specify} value={lcData.previouslyPadronDs} disabled={true} />
                                </div>

                            </div>
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.workingWalmart} value={renderYesNo(lcData.subsidiaryWalmartMexico)} disabled={true} />
                                </div>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specify} value={lcData.previouslySubsidiaryDs} disabled={true} />
                                </div>
                            ...
                            <div className='row'>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.rankWalmart} value={renderYesNo(lcData.subsidiariesWalmartFacility)} disabled={true} />
                                </div>
                                <div className='col s12 m6 '>
                                    <InputText field={FormFields.specify} value={lcData.previouslySubsidiaryPadronDs} disabled={true} />
                                </div>
